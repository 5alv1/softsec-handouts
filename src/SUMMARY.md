...
- [In the age of ancients the world was unsecure, shrouded by bugs.](./intro/intro.md)
    - [They're speaking the language of the gods](./intro/assembly.md)
    - [One does not simply walk into a function](./intro/calling.md)
    - [THE WORLD! When Breakpoints Stop Time](./intro/debugger.md)
    - [THE WORLD! When Breakpoints Stop Time (with colors)](./intro/pwndbg.md)
